...
local title_string = "1wxre | User Status : "..CheckStatus(game.Players.LocalPlayer.Name).." | %A, %B"
...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/ShxrkWare/Lib/main/1wxrelib.lua'))()
